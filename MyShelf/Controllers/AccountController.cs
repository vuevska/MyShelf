...
namespace MyShelf.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AddUserToRole()
        {
            ...
            model.Roles = new List<string> { "Administrator", "StdUser" };
            return View(model);
        }
        ...
        public ActionResult AddUserToRole(AddToRoleModel model)
        {
            ...
            if (user == null)
                throw new HttpException(404, "User with this email doesn't exist");
            if (model.SelectedRole == "Administrator")
                UserManager.RemoveFromRole(user.Id, "StdUser");
            if (model.SelectedRole == "StdUser" && User.IsInRole("Administrator"))
